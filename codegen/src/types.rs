    ...
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        match self.ty.type_def() {
            TypeDef::Composite(composite) => {
                ...
                let ty_toks = quote! {
                    #[derive(Debug, Eq, PartialEq, Clone, Ord, PartialOrd, ::codec::Encode, ::codec::Decode #derive_as_compact)]
            ...
            TypeDef::Variant(variant) => {
                ...
                let ty_toks = quote! {
                    #[derive(Debug, Eq, PartialEq, Clone, Ord, PartialOrd, ::codec::Encode, ::codec::Decode)]
                    pub enum #type_name {
                        #( #variants, )*
                    }
                };
